...
export default function App() {
      ...
      case "home":
        return (
          <HomePage
            ...
            onModalStateChange={setIsQuickPlayOpen}
          />
        );
      case "reader":
        return (
  ...
  return (
    <div className="size-full flex bg-gradient-to-br from-[#1a2942] via-[#253854] to-[#2d4663] relative">
      ...
      <div
        className={`absolute inset-0 pointer-events-none ${currentPage === "reader" ? "opacity-5" : "opacity-30"}`}
      >
        {[...Array(50)].map((_, i) => (
          <div
            key={i}
      ...
      <motion.div
        ...
        className={`relative z-20 ${isQuickPlayOpen ? 'hidden md:block' : ''}`}
      >
        <Sidebar
      ...
      <div className="flex-1 flex flex-col relative z-10 overflow-y-auto min-h-full pb-16 md:pb-0">
        {renderPage()}
      </div>
